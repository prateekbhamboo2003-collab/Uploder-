...
photologo = 'https://i.ibb.co/CK3m69vN/sample.png' #https://envs.sh/GV0.jpg
photoyt = 'https://i.ibb.co/CK3m69vN/sample.png' #https://envs.sh/GVi.jpg
photocp = 'https://i.ibb.co/CK3m69vN/sample.png'
photozip = 'https://i.ibb.co/CK3m69vN/sample.png'


# Inline keyboard for start command
BUTTONSCONTACT = InlineKeyboardMarkup([[InlineKeyboardButton(text="📞 Contact", url="https://t.me/algoshayar0")]])
keyboard = InlineKeyboardMarkup(
    [
        [InlineKeyboardButton(text="🛠️ Help", url="https://t.me/alogshayar0"), InlineKeyboardButton(text="🛠️ Repo", url="https://github.com/shayarop")],
    ]
)

# Image URLs for the random image feature
image_urls = [
    "https://i.ibb.co/CK3m69vN/sample.png",
    "https://i.ibb.co/CK3m69vN/sample.png",
...
async def start(bot, m: Message):
    ...
    start_message = await bot.send_photo(
        chat_id=m.chat.id,
        photo="https://i.ibb.co/CK3m69vN/sample.png",
        caption=caption
    )
    ...
    if m.chat.id in AUTH_USERS:
        keyboard = InlineKeyboardMarkup([
            ...
            [InlineKeyboardButton(text="📞 Contact", url=f"tg://openmessage?user_id={OWNER}"), InlineKeyboardButton(text="🛠️ Repo", url="https://github.com/shayarop")],
        ])
...
async def back_to_main_menu(client, callback_query):
    ...
    await callback_query.message.edit_media(
      InputMediaPhoto(
        media="https://i.ibb.co/CK3m69vN/sample.png",
        caption=caption
      ),
    ...
    try:
        for i in range(arg-1, len(links)):
            ...
            if "acecwply" in url:
                ...
                url = f"https://marco-cp-api.vercel.app/marco?url={url}@ITSMARCOOFFICIAL&user_id=7620536220"
